...
\item $^\ddagger$ HANK cycle correlation omitted, as potential is defined as the representative-agent counterfactual, making the true cycle a model-specific residual rather than a filter-interpretable object.
\end{tablenotes}
\end{threeparttable}
\end{table}
